<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO product (uid, product, pcat, pinfo, price)
			   VALUES ('$uid', '$productName', '$productType', '$productInfo', '$productPrice')";
		...
		if(in_array($picActualExt, $allowed))
		{
			if($picError === 0)
			{
				...
				$sql = "UPDATE product SET picStatus=1, pimage='$picNameNew' WHERE product='$productName';";
